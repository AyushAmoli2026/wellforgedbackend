...
export const processPayment = async (req, res) => {
    ...
    try {
        ...
        const paymentResult = await pool.query(`INSERT INTO payments (order_id, payment_method, payment_status, transaction_id, paid_at) 
       VALUES ($1, $2, $3, $4, CURRENT_TIMESTAMP) 
       ON CONFLICT (order_id) 
       DO UPDATE SET payment_status = $3, transaction_id = $4, paid_at = CURRENT_TIMESTAMP
       RETURNING *`, [order_id, payment_method, 'success', transaction_id]);
